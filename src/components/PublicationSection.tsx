...
const PublicationSection = () => {
    ...
    return (
        <section id="publication" className="section-padding relative overflow-hidden">
            {/* Background */}
            <div className="absolute inset-0 bg-gradient-to-b from-[#faf8f5] via-white to-[#f5f3ef] dark:from-dark-900 dark:via-dark-800 dark:to-dark-900 transition-colors duration-300" />

            {/* Decorative elements */}
            <div className="orb orb-violet w-80 h-80 -top-20 right-[10%] opacity-20 dark:opacity-20" />
            <div className="orb orb-coral w-64 h-64 bottom-40 left-[5%] opacity-20 dark:opacity-20" />
            <div className="orb orb-cyan w-48 h-48 top-1/2 right-[5%] opacity-15 dark:opacity-15" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                {featuredPost && (
                    <motion.div
                        ...
                        className="mb-12"
                    >
                        <Link to={`/publications/${featuredPost.slug}`} className="block">
                                ...
                                <div className="grid lg:grid-cols-2 gap-0">
                                    ...
                                    <div className="p-8 lg:p-10 flex flex-col justify-center">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="flex items-center gap-2 text-sm font-medium text-coral group-hover:gap-3 transition-all">
                                                Read Article
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    {regularPosts.map((post, index) => (
                        ...
                        >
                            <Link to={`/publications/${post.slug}`} className="group cursor-pointer block h-full">
                ...
                >
                    <Link
                        to="/publications"
                        className="inline-flex items-center gap-3 px-8 py-4 rounded-full border-2 border-slate-300 dark:border-white/20 text-slate-700 dark:text-white font-medium hover:border-violet/50 hover:bg-violet/5 dark:hover:bg-white/5 transition-all group"
                    >
